...
// Offset points *away* from the trigger, so content originates near the
// trigger and rises into resting position.
...
// initial delay, so moving along a toolbar feels instant after the first one.
              ...
              {open && coords ? (
                ...
                >
                  <motion.span
                    ...
                    className={cn(
                      "block rounded-lg border border-border bg-background px-2.5 py-1 text-xs font-medium whitespace-nowrap text-foreground shadow-lg",
                      className
                    )}
                  >
                    {content}
